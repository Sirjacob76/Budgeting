...
choice, defaults to your device preference). The layout is **phone-first**: a swipeable tab row,
full-width form controls, and bills that render as reflowing cards (no cramped tables).
