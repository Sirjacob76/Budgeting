...
| **Income & Bills** | Enter income, recurring bills (with a **due day** and **autopay** flag), and automated savings goals. A **"Your plan" panel** shows exactly what's **left after bills**, how much to **put back (save)**, and what you're **free to spend** — plus recommendations based on the 50/30/20 rule (flags bills running over ~50% of income, nudges savings toward 20%). |
